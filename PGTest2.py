...
#    bgd = pygame.Surface(SCREENRECT.size)
    #backgroundImg = pygame.image.load('Images\\BackgroundImages\Space Background.png')
#    bgd.blit(pygame.image.load('Images\\BackgroundImages\Space Background.png'),(0,0))
